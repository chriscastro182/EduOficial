<?php
    ...
    function encryptAndEncode($text){
      $alan = new alanAESSeguro();
      return base64_encode($alan->aes256_cbc_encrypt($text));
    }
    function DecodeAndDecrypt($text){
      $alan = new alanAESSeguro();
      return $alan->aes256_cbc_decrypt(base64_decode($text));
    }

class alanAESSeguroConParametros{
